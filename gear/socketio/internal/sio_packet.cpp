...
using namespace std;
// void accept_message(message const& msg, Value& val, Document& doc,
//                     vector<shared_ptr<const string> >& buffers);
//
// void accept_bool_message(bool_message const& msg, Value& val) { val.SetBool(msg.get_bool()); }
//
// void accept_null_message(Value& val) { val.SetNull(); }
//
// void accept_int_message(int_message const& msg, Value& val) { val.SetInt64(msg.get_int()); }
//
...
// }
//
// void accept_array_message(array_message const& msg, Value& val, Document& doc,
//                           vector<shared_ptr<const string> >& buffers) {
//   val.SetArray();
...
// }
//
// void accept_object_message(object_message const& msg, Value& val, Document& doc,
//                            vector<shared_ptr<const string> >& buffers) {
//   val.SetObject();
...
//       static_cast<array_message*>(ptr.get())->get_vector().push_back(from_json(value[i],
//       buffers));
//     }
//     return ptr;
